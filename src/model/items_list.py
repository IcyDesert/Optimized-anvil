...
__iu = set(e.item_universial)  # Item_Universal，这是所有物品魔咒的必备项
__au = __iu | set(e.armor_universal)  # Armor_Universal
__hs = __au | {e.armor_specific[0], e.armor_specific[2]} # Helmet_specific，后面两个分别是「水下呼吸」和「水下速掘」
__bts = __au | {e.armor_specific[1]}  # BooT_specific，后面是「深海探索者」
